...
namespace SuperShop.Data
{
    public class OrderRepository : GenericRepository<Order>, IOrderRepository
    {
        ...
        public async Task<IQueryable<OrderDetailTemp>> GetDetailTempsAsync(string userName)
        {
            ...
            return _context.OrderDetailsTemp.Include(p => p.Product).Where(u => u.User == user).OrderBy(o => o.Product.Name);
        }
        ...
        public async Task<IQueryable<Order>> GetOrderAsync(string userName)
        {
            ...
            {
                return _context.Orders.Include(u => u.User).Include(o => o.Items).ThenInclude(p => p.Product).OrderByDescending(d => d.OrderDate);
            }
            else
            {
                return _context.Orders.Include(o => o.Items).ThenInclude(p => p.Product).Where(u => u.User == user).OrderByDescending(d => d.OrderDate);
            }
        }
